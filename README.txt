== Description ==
*** Create Man Page for this.
*** Create easier to follow README - less text, more function
*** Add to SourceForge account

SNUMM's NOT Unofficial Moo_dle Mobile

This is a fork of the unofficial clone of the Moodle Mobile app for iPhone that works on Android and Blackberry devices.
It should work also on iPhone and iPad.
This is based off of UMM - Unofficial Moodle Mobile.
...
M. Kaoru Wilbur <humm@faqlinux.com>
http://www.faqlinux.com
Moodle Profile:
